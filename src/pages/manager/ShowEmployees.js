...
const ShowEmployees = () => {
  ...
  const getChartData = () => {
    setChartData({
      ...
      datasets: [
        {
          label: 'Work Load',
          data: employees.map((item) => item.workCount),
  ...
  return (
    <>
      <div className="container bg-white border rounded mx-auto mt-3 py-3 px-3">
        ...
        <div className="row">
          <div className='col-lg-3 col-md-3 col-sm-12 col-xs-12'>
            {loadingData === false ? (<>
              {employees.map((employee) => (<>
                <div className="card mb-2 border-0 border-start border-3 border-primary-subtle rounded-0 shadow-sm">
                  <div className="card-body p-1 ps-3 border border-1 border-primary-subtle">
          ...
          <div className='col-lg-9 col-md-9 col-sm-12 col-xs-12'>
            {loadingData === false ? (<>
              <div className='h-100 w-100 border border-primary-subtle p-2 shadow-sm'>
                <Bar
                  options={{
